...
problematic :   Describe importance to monitor eq and subduction zone
   ...
   State of the art
       ...
       \done[inline]{ [olson, 1957] : eq. provokes acoustic vibration as loudspeaker }
        
        [ ] couplage terre/eau/atmo 
       
        [ ] : N-shape 
        
        \done[inline]{[Calais, 1995] : use GNSS to study it}
